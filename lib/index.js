 ...
 */
module.exports.isProjectValid = function(input, options) {
  if (isEmpty(input)) {
    return DEFAULT_PROJECT;
  }
  ...
  try {
    ...
    if (options.strict && !_.every(parsed, isValueOkforProject)) {
...
module.exports.validate = function(what, input, options) {
  options = options || {strict: true};
